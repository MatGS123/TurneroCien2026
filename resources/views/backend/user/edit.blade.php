                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3 select2-dark">
                                            <label for="service_id" class="my-0">
                                                <i class="fas fa-id-card"></i> Seleccionar servicio
                                            </label>
                                            <small class="text-muted"> Vincula a los empleados con los servicios que tienen asignados</small>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                            ...
                                            <small class="text-muted"> Crea turnos según la 
                                                duración seleccionada.</small>
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <small class="text-muted">
                                                ...
                                                opción a añadir varios intervalos en 
                                                el día, ej: 9 AM-12 PM y 4 PM-8 PM.
                                            </small>
                                        </div>
...
if ($usingOldInput) {
    ...
    // Format date for input field if it's not already in YYYY-MM-DD format
                                                ...
                                                @empty
                                                    <p>No hay días festivos para este usuario. Haz click en "Añadir día festivo" para agregar uno.
                                                    </p>
                                                @endforelse
                                            </div>
                                        </div>
